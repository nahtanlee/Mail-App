...
[[ stitchable ]] half4 variableBlur(float2 pos, SwiftUI::Layer layer, float4 boundingRect, float radius, float maxSamples, float vertical) {
    ...
    const half pixelRadius = 1 * half(radius);
